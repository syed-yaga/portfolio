    ...
    return <section className="py-24 px-4 relative bg-secondary/30">
      ...
      <div className="space-y-8">
          ...
          <div className="space-y-6 justify-center">
           <div className="flex items-start space-x-4">
               ...
               <div>
                ...
                <a href="mailto:soharwardiandco27@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                    soharwardiandco27@gmail.com
                </a>
               </div>
           </div>
            <div className="flex items-start space-x-4">
               ...
               <div>
                ...
                <a href="tel:+919589203123" className="text-muted-foreground hover:text-primary transition-colors">
                   +919589203123
                </a>
               </div>
           </div>
         ...
         <div className="flex space-x-4 justify-center">
           <a href="https://x.com/babayaga_798" target="_blank">
            <X/>
           </a>
         </div>
          </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div>
                ...
                <input type="email" id="email" name="email" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary" placeholder="raghav@gmail.com"/>
            </div>  <div>
